        ...
        <div class="main-sidebar">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active">
                        <a href="{{route('dashboard')}}" class="nav-link"><i class="fas fa-columns"></i> <span>data pegawai</span></a>
                    </li>
...
{{--                    </li>--}}
                    <li class="active">
                        <a href="{{route('setting')}}" class="nav-link"><i class="fas fa-cog"></i> <span>setting</span></a>
                    </li>
                    <li class="active">
                        <a href="{{route('dashboard')}}" class="nav-link"><i class="fas fa-database"></i> <span>hasil rekomendasi</span></a>
                    </li>
                </ul>
